...
protected:
    ...
    CFileAISafetyView* GetFileAISafetyView() const { return m_fileTabbedView->GetFileAISafetyView(); }
    ...
    afx_msg void OnAISafetyCheck();
    afx_msg void OnUpdateAISafetyCheck(CCmdUI* pCmdUI);
