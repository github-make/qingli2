...
class COptions final
{
    ...
    static LPCWSTR OptionsAISafety;
...
public:
    ...
    static Setting<std::wstring> AIApiKey;
    static Setting<std::wstring> AIApiUrl;
    static Setting<std::wstring> AIModel;
    static Setting<std::wstring> AICustomRules;
    static Setting<int> AIBatchSize;
    static Setting<std::vector<int>> AISafetyViewColumnOrder;
    static Setting<std::vector<int>> AISafetyViewColumnWidths;
