...
public:
    ...
    bool IsFileAISafetyViewTabActive() { return GetTabControl().GetActiveTab() == m_fileAISafetyViewIndex; }
    ...
    CFileAISafetyView* GetFileAISafetyView() const { return m_fileAISafetyView; }
    ...
    void SetActiveAISafetyView() { SetActiveView(m_fileAISafetyViewIndex); }
    ...
    void SetAISafetyTabVisibility(bool show = true);
    ...
    bool IsAISafetyTabVisible() { return GetTabControl().IsTabVisible(m_fileAISafetyViewIndex); }
...
protected:
    ...
    int m_fileAISafetyViewIndex = -1;
    CFileAISafetyView* m_fileAISafetyView = nullptr;
