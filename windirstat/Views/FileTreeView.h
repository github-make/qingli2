...
class CFileAISafetyView final : public CControlView
{
protected:
    DECLARE_DYNCREATE(CFileAISafetyView)
    CFileAISafetyView() = default;
    ~CFileAISafetyView() override = default;

    CTreeListControl& GetControl() override { return m_control; }
    const CTreeListControl& GetControl() const override { return m_control; }

    CFileAISafetyControl m_control;
