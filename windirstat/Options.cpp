...
LPCWSTR COptions::OptionsAISafety = L"AISafety";
...
Setting<std::wstring> COptions::AIApiKey(OptionsAISafety, L"ApiKey");
Setting<std::wstring> COptions::AIApiUrl(OptionsAISafety, L"ApiUrl", L"https://api.siliconflow.cn/v1/chat/completions");
Setting<std::wstring> COptions::AIModel(OptionsAISafety, L"Model", L"Qwen/Qwen2.5-7B-Instruct");
Setting<std::wstring> COptions::AICustomRules(OptionsAISafety, L"CustomRules");
Setting<int> COptions::AIBatchSize(OptionsAISafety, L"BatchSize", 10, 1, 50);
Setting<std::vector<int>> COptions::AISafetyViewColumnOrder(OptionsAISafety, L"ColumnOrder");
Setting<std::vector<int>> COptions::AISafetyViewColumnWidths(OptionsAISafety, L"ColumnWidths");
